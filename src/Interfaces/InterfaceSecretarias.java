 ...
 * @author DANIS
 */
public class InterfaceSecretarias extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceDocentes
     */
    public InterfaceSecretarias() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceSecretarias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceSecretarias().setVisible(true);
            }
        });
    }
